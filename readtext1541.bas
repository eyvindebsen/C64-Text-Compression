0 poke53272,23:poke53281,0:poke53280,12
1 print"{clear}{white}Bible reader v0.7 by Eyvind Ebsen 2024{light green}":?
5 mc=127:dimc%(mc,2),c$(mc),x(15):cc=0:du=1:cs=18:dv=9
6 gosub9520::gosub800:goto940:rem cache du=do upper;hoyo decode
...
824 open 3,dv,3,"chron2,s,r":gosub1000
